...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(f"out1_feature.size(): {out1_feature.size()}")
        # print(f"out2_feature.size(): {out2_feature.size()}")
        # print(f"out3_feature.size(): {out3_feature.size()}")
        # print(f"out4_feature.size(): {out4_feature.size()}")
