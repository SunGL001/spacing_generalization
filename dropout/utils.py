...
def get_training_dataloader(dataset, batch_size=16, num_workers=2, shuffle=True):
    ...
    if dataset == 'cifar100':
        ...
        data = torchvision.datasets.ImageFolder('/data/datasets/ImageNet-100/train', transform=transform_train)
        loader = DataLoader(data, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size)
        ...
        train_path = '/home/liyuan/data/CUB_200_2011/dataset/train'
...
def get_test_dataloader(dataset, batch_size=16, num_workers=4, shuffle=False):
    ...
    if dataset == 'cifar100':
        ...
        transform_test=transforms.Compose([
            ...
            transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                    std=[0.229, 0.224, 0.225]), ])
        data = torchvision.datasets.ImageFolder('/data/datasets/ImageNet-100/val', transform=transform_test)
        loader = DataLoader(data, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size)
        ...
        test_path = '/home/liyuan/data/CUB_200_2011/dataset/test'
        testset = torchvision.datasets.ImageFolder(root=test_path, transform=transform_test)
        loader = torch.utils.data.DataLoader(testset, batch_size=batch_size, shuffle=False, num_workers=num_workers)
